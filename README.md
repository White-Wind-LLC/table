...
```kotlin
dependencies {
    implementation("ua.wwind.table-kmp:table-core:1.6.1")
    // optional
    implementation("ua.wwind.table-kmp:table-format:1.6.1")
    implementation("ua.wwind.table-kmp:table-paging:1.6.1")
}
```
