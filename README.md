...
```kotlin
dependencies {
    implementation("ua.wwind.table-kmp:table-core:1.8.3")
    // optional
    implementation("ua.wwind.table-kmp:table-format:1.8.3")
    implementation("ua.wwind.table-kmp:table-paging:1.8.3")
}
```
