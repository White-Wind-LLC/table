...
```kotlin
dependencies {
    implementation("ua.wwind.table-kmp:table-core:1.7.2")
    // optional
    implementation("ua.wwind.table-kmp:table-format:1.7.2")
    implementation("ua.wwind.table-kmp:table-paging:1.7.2")
}
```
