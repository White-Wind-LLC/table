...
```kotlin
dependencies {
    implementation("ua.wwind.table-kmp:table-core:2.4.0")
    // optional
    implementation("ua.wwind.table-kmp:table-format:2.4.0")
    implementation("ua.wwind.table-kmp:table-paging:2.4.0")
}
```
