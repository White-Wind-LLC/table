...
data class Person(
     ...
     * Generated pseudo-randomly based on person immutable data.
     */
    val movements: List<PersonMovement> = generateMovements()

    /**
     * Generates deterministic pseudo-random movements for the person.
     * First movement is hiring on [hireDate] to a random position.
     * Then from 2 to 6 movements, where the last movement ends on [position].
     */
